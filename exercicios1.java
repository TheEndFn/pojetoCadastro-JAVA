...
public class exercicios1 {
	...
	public static void main(String[] args) {
		...
		JFrame janela = new JFrame("CADASTRO"); //Cria a minha janela com título
		...
		resposta0.setBounds(520, 40, 200, 25);
		
		JLabel resposta1 = new JLabel();
		resposta1.setBounds(520, 80, 200, 25);
		
		JLabel resposta2 = new JLabel();
		resposta2.setBounds(520, 120, 200, 25);
		
		
		botao0.addActionListener(e -> {
			String nome = campoTexto0.getText();
			resposta0.setText(nome);
		});
		...
		janela.add(botao2);
		janela.add(botao02);
		janela.add(resposta0);
		janela.add(resposta1);
		janela.add(resposta2);
